...
public struct FullScreenCoverModifierRenderer: ModifierRenderer {
  public static let key: AttributeKey = .fullScreenCover
...
private struct FullScreenCoverWrapper<Content: View>: View {
  let sheetId: String
...
#Preview {
  DebugView {
    ...
    .fullScreenCover {
      VStackNode {
        TextNode("Full Screen Cover Content")
          .font(.headline)
        
        TextNode("This is inside a full screen cover")
          .padding()
      }
    }
  }
